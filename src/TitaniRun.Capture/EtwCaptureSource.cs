...
{
    /// <summary>Default session name used by TitaniRun. Stable across restarts.</summary>
    public const string DefaultSessionName = "TitaniRun.Capture";
